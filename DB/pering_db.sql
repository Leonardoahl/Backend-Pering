...
<<<<<<< HEAD
-- Sun Sep 24 15:40:57 2023
=======
-- Tue Sep 26 22:49:44 2023
>>>>>>> dev
...
CREATE TABLE IF NOT EXISTS `pering`.`users_has_soft_skills` (
  `has_soft_skills_id` BIGINT NOT NULL AUTO_INCREMENT,
  `fk_users_id` BIGINT NOT NULL,
  `fk_soft_skills_id` BIGINT NOT NULL,
  PRIMARY KEY (`has_soft_skills_id`, `fk_users_id`, `fk_soft_skills_id`),
...
CREATE TABLE IF NOT EXISTS `pering`.`users_has_tech_skills` (
  `has_tech_skills_id` BIGINT NOT NULL AUTO_INCREMENT,
  `fk_users_id` BIGINT NOT NULL,
  `fk_tech_skills_id` BIGINT NOT NULL,
  PRIMARY KEY (`has_tech_skills_id`, `fk_users_id`, `fk_tech_skills_id`),
...
CREATE TABLE IF NOT EXISTS `pering`.`users_has_connections` (
  `has_connections_id` BIGINT NOT NULL AUTO_INCREMENT,
  `fk_users_id` BIGINT NOT NULL,
  `fk_connections_id` BIGINT NOT NULL,
  PRIMARY KEY (`has_connections_id`, `fk_users_id`, `fk_connections_id`),
